...
<head>
    ...
    <link rel='stylesheet' id='thickbox-css'  href='/cakephp/js/thickbox/thickbox.css' type='text/css' media='all' />
    <?php
        // <!-- RESET STYLESHEET -->
        ...
        echo $this->Html->css('portfolios/full-description/css/style');
        echo $this->Html->css('portfolios/slide-detail/css/style');
        echo $this->Html->css('shortcodes');
        echo $this->Html->css('colorbox');
        echo $this->Html->css('buttons/mfast-3');
        echo $this->Html->css('sliders/flexslider/css/flexslider');
        echo $this->Html->css('sliders/flexslider-elegant/css/slider');
        echo $this->Html->css('sliders/revolution-slider/css/slider');
        echo $this->Html->css('sliders/revolution-slider/rs-plugin/css/settings');
        echo $this->Html->css('sliders/revolution-slider/rs-plugin/css/captions');
                ...
                <div class="row">
                    ...
                    <div id="logo" class="span4 group">
                        <a id="logo-img" href="index.html" title="celestino">
                            <?php echo $this->Html->image('celestino1.png', array('alt'=>'celestino','title'=>'celestino')) ?>
                        </a>
            ...
            <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;max-height:400px;height:400;">
                <ul>
                    <li data-transition="random" data-slotamount="7" data-masterspeed="300" >
                        <?php echo $this->Html->image('slider/1-bg.jpg') ?>
                        ...
                        <div class="tp-caption lfb"
                            ...
                            <?php echo $this->Html->image('slider/1-l1.png',array('alt'=>'Image1')); ?>
                        </div>
                        ...
                        <div class="tp-caption lfb"
                             ...
                             data-start="2500"
                             data-easing="easeOutQuint"  >
                            <?php echo $this->Html->image('slider/1-l2.png',array('alt'=>'Image 5')); ?>
                        </div>
                        ...
                        <div class="tp-caption lft"
                            ...
                            <?php echo $this->Html->image('slider/1-l3.png',array('alt'=>'Image 8')); ?>
                        </div>
                        ...
                        <div class="tp-caption lfr"
                             ...
                             data-start="3400"
                             data-easing="easeOutQuint"  >
                            <?php echo $this->Html->image('slider/1-l4.png',array('alt'=>'Image 9')); ?>
                        </div>
                        ...
                        <div class="tp-caption lfl"
                             ...
                             data-start="3800"
                             data-easing="easeOutQuint"  >
                            <?php echo $this->Html->image('slider/1-l5.png',array('alt'=>'Image 10')); ?>
                        </div>
                        ...
                        <div class="tp-caption lft"
                             ...
                             data-start="4200"
                             data-easing="easeOutQuint"  >
                            <?php echo $this->Html->image('slider/1-l6.png',array('alt'=>'Image 11')); ?>
                        </div>
                        ...
                        <div class="tp-caption lfb"
                             ...
                             data-start="4600"
                             data-easing="easeOutQuint"  >
                            <?php echo $this->Html->image('slider/1-l7.png',array('alt'=>'Image 12')); ?>
                        </div>
                        ...
                        <div class="tp-caption lft"
                             ...
                             data-start="5200"
                             data-easing="easeOutQuint"  >
                            <?php echo $this->Html->image('slider/1-l8.png',array('alt'=>'Image 13')); ?>
                        </div>
                    </li>
                <li data-transition="random" data-slotamount="7" data-masterspeed="300" >
                    <?php echo $this->Html->image('slider/2-bg.jpg',array('alt'=>'2-bg')); ?>
                    ...
                    <div class="tp-caption lft"
                         ...
                         data-start="1600"
                         data-easing="easeOutQuint"  >
                        <?php echo $this->Html->image('slider/2-l1.png',array('alt'=>'Image 4')); ?>
                    </div>
                    ...
                    <div class="tp-caption lfb"
                         ...
                         data-start="2000"
                         data-easing="easeOutQuint"  >
                        <?php echo $this->Html->image('slider/2-l2.png',array('alt'=>'Image 5')); ?>
                    </div>
                    ...
                    <div class="tp-caption lfl"
                         ...
                         data-start="2400"
                         data-easing="easeOutQuint"  >
                        <?php echo $this->Html->image('slider/2-l3.png',array('alt'=>'Image 6')); ?>
                    </div>
                </li>
                <li data-transition="random" data-slotamount="7" data-masterspeed="300" >
                    <?php echo $this->Html->image('slider/3-bg.jpg',array('alt'=>'3-bg')); ?>
                    ...
                    <div class="tp-caption lfl"
                         ...
                         data-start="4200"
                         data-easing="easeOutQuint"  >
                        <?php echo $this->Html->image('slider/3-l3.png',array('alt'=>'Image 14')); ?>
                    </div>
                    ...
                    <div class="tp-caption lfr"
                         ...
                         data-start="4500"
                         data-easing="easeOutQuint"  >
                        <?php echo $this->Html->image('slider/3-l1.png',array('alt'=>'Image 15')); ?>
                    </div>
                    ...
                    <div class="tp-caption lfb"
                         ...
                         data-start="5000"
                         data-easing="easeOutQuint"  >
                        <?php echo $this->Html->image('slider/3-l2.png',array('alt'=>'Image 15')); ?>
                    </div>
                </li>
                </ul>
            </div>
...
<div id="primary" class="sidebar-no">
    <div class="container group">
        ...
        <div class="row">
            <ul id="portfolio" class="slide-detail detail thumbnails">
                ...
                <li  class="filterable_item span3 brandidentity  logodesign  webdesign  first">
                    ...
                    <div class="ch-item ch-item-hover" style="background: url('/cakephp/img/portfolios/001-260x172.jpg') no-repeat center;">

                <div class="ch-info">
                    <div class="ch-info-icons">
                        <a href="/cakephp/img/portfolios/001.jpg" rel="lightbox" class="ch-info-lightbox">
                            <?php echo $this->Html->image('icons/zoom.png',array('alt'=>'Open Lightbox')); ?>
                        </a>
                        <a href="portfolios/portfolio-detail/?cpt_item=bob-miller" class="open_slide">
                            <?php echo $this->Html->image('icons/project.png'); ?>
                        </a>
                    </div>
                        ...
                        <div class="work-thumbnail span6">
                            <div class="thumb-wrapper">
                                ...
                                <div class="extra-images-slider">
                                    <ul class="slides">
                                        <li>
                                            <img width="574" height="340" src="/cakephp/img/portfolios/001-574x340.jpg" class="attachment-thumb_portfolio_fulldesc" alt="001" />
                                        </li>
                                        <li>
                                            <img width="574" height="340" src="/cakephp/img/portfolios/001-574x340.jpg" class="attachment-thumb_portfolio_fulldesc" alt="001" />
                                        </li>
                                        <li>
                                            <img width="574" height="340" src="/cakephp/img/portfolios/0062-574x340.jpg" class="attachment-thumb_portfolio_fulldesc" alt="006" />
                                        </li>
                                    </ul>
                                </div>
                                <script type="text/javascript">
        ...
        <li  class="filterable_item span3 brandidentity  logodesign ">
            ...
            <div class="ch-item ch-item-hover" style="background: url('/cakephp/img/blog/0023-260x172.jpg') no-repeat center;">

                <div class="ch-info">
                    <div class="ch-info-icons">
                        <a href="/cakephp/img/blog/0023.jpg" rel="lightbox" class="ch-info-lightbox">
                            <?php echo $this->Html->image('icons/zoom.png',array('alt'=>'Open Lightbox')); ?>
                        </a>
                    ...
                    <div class="page type-page status-publish hentry work group row">
                        <div class="work-thumbnail span6">
                            <div class="thumb-wrapper">
                                <a class="thumb">
                                    <?php
                                        echo $this->Html->image('portfolios/0023-574x340.jpg',array('class'=>'attachment-thumb_portfolio_fulldesc','alt'=>'002','width'=>'574','height'=>'340'));
                                    ?>
                                </a>
                            </div>
                        </div>
        ...
        <li  class="filterable_item span3 brandidentity  logodesign ">
            ...
            <div class="ch-item ch-item-hover" style="background: url('/cakephp/img/portfolios/00311-260x172.jpg') no-repeat center;">

                <div class="ch-info">
                    <div class="ch-info-icons">
                        <a href="/cakephp/img/portfolios/0037.jpg" rel="lightbox" class="ch-info-lightbox">
                            <img src="/cakephp/img/icons/zoom.png" alt="Open Lightbox" />
                        </a>
                        <a href="portfolios/portfolio-detail/?cpt_item=nili-studios" class="open_slide">
                            <img src="/cakephp/img/icons/project.png" alt="" />
                        </a>
                    </div>
                    ...
                    <div class="page type-page status-publish hentry work group row">
                        <div class="work-thumbnail span6">
                            <div class="thumb-wrapper">
                                ...
                                <a class="thumb">
                                    <img width="574" height="340" src="/cakephp/img/portfolios/0034-574x340.jpg" class="attachment-thumb_portfolio_fulldesc" alt="003" />
                                </a>
                            </div>
                        </div>
        ...
        <li  class="filterable_item span3 webdesign ">
            ...
            <div class="ch-item ch-item-hover" style="background: url('/cakephp/img/portfolios/0047-260x172.jpg') no-repeat center;">

                <div class="ch-info">
                    <div class="ch-info-icons">
                        <a href="/cakephp/img/portfolios/0411.jpg" rel="lightbox" class="ch-info-lightbox">
                            <img src="/cakephp/img/icons/zoom.png" alt="Open Lightbox" />
                        </a>
                ...
                <div class="container portfolio-full-description">
                    ...
                    <div class="page type-page status-publish hentry work group row">
                        <div class="work-thumbnail span6">
                            <div class="thumb-wrapper">
                                <a class="thumb">
                                    <img width="574" height="340" src="/cakephp/img/portfolios/0043-574x340.jpg" class="attachment-thumb_portfolio_fulldesc" alt="004" />
                                </a>
                            </div>
                        </div>
        ...
        <li  class="filterable_item span3 brandidentity  webdesign  first">
            ...
            <div class="ch-item ch-item-hover" style="background: url('/cakephp/img/portfolios/00511-260x172.jpg') no-repeat center;">

                <div class="ch-info">
                    <div class="ch-info-icons">
                        <a href="/cakephp/img/portfolios/0051.jpg" rel="lightbox" class="ch-info-lightbox">
                            <img src="/cakephp/img/icons/zoom.png" alt="Open Lightbox" />
                        </a>
                        <a href="portfolios/portfolio-detail/?cpt_item=colorful-oktopus" class="open_slide">
                            <img src="/cakephp/img/icons/project.png" alt="" /></a>									</div>
                    ...
                    <div class="page type-page status-publish hentry work group row">
                        <div class="work-thumbnail span6">
                            <div class="thumb-wrapper">
                                ...
                                <a class="thumb">
                                    <img width="574" height="340" src="/cakephp/img/portfolios/0054-574x340.jpg" class="attachment-thumb_portfolio_fulldesc" alt="005" />
                                </a>
                            </div>
                        </div>
        ...
        <li  class="filterable_item span3 brandidentity  webdesign ">
            ...
            <div class="ch-item ch-item-hover" style="background: url('/cakephp/img/portfolios/0072-260x172.jpg') no-repeat center;">

                <div class="ch-info">
                    <div class="ch-info-icons">
                        <a href="/cakephp/img/portfolios/0071.jpg" rel="lightbox" class="ch-info-lightbox">
                            <img src="/cakephp/img/icons/zoom.png" alt="Open Lightbox" />
                        </a>
                ...
                <div class="container portfolio-full-description">
                    ...
                    <div class="page type-page status-publish hentry work group row">
                        <div class="work-thumbnail span6">
                            <div class="thumb-wrapper">
                                <a class="thumb">
                                    <img width="574" height="340" src="/cakephp/img/portfolios/0072-574x340.jpg" class="attachment-thumb_portfolio_fulldesc" alt="007" />
                                </a>
                            </div>
                        </div>
        ...
        <li  class="filterable_item span3 brandidentity  logodesign  webdesign ">
            ...
            <div class="ch-item ch-item-hover" style="background: url('/cakephp/img/portfolios/piggie88-260x172.jpg') no-repeat center;">

                <div class="ch-info">
                    <div class="ch-info-icons">
                        <a href="/cakephp/img/portfolios/piggie88-574x340.jpg" rel="lightbox" class="ch-info-lightbox">
                            <img src="/cakephp/img/icons/zoom.png" alt="Open Lightbox" />
                        </a>
                    ...
                    <div class="page type-page status-publish hentry work group row">
                        <div class="work-thumbnail span6">
                            <div class="thumb-wrapper">
                                ...
                                <a class="thumb">
                                    <img width="574" height="340" src="/cakephp/img/portfolios/piggie88-574x340.jpg" class="attachment-thumb_portfolio_fulldesc" alt="008" />
                                </a>
                            </div>
                        </div>
        ...
        <li  class="last filterable_item span3 logodesign">
            ...
            <div class="ch-item ch-item-hover" style="background: url('/cakephp/img/portfolios/0098-260x172.jpg') no-repeat center;">

                <div class="ch-info">
                    <div class="ch-info-icons">
                        <a href="/cakephp/img/portfolios/009.jpg" rel="lightbox" class="ch-info-lightbox">
                            <img src="/cakephp/img/icons/zoom.png" alt="Open Lightbox" />
                        </a>
                ...
                <div class="container portfolio-full-description">
                    ...
                    <div class="page type-page status-publish hentry work group row">
                        <div class="work-thumbnail span6">
                            <div class="thumb-wrapper">
                                <a class="thumb">
                                    <img width="574" height="340" src="/cakephp/img/portfolios/0091-574x340.jpg" class="attachment-thumb_portfolio_fulldesc" alt="009" />
                                </a>
                            </div>
                        </div>
        ...
        <div class="one-fourth ">
            <div class="random-numbers">
                <img src="/cakephp/img/110.jpg" alt="" width="52" height="52" />
        ...
        <div class="one-fourth ">
            <div class="random-numbers">
                <img src="/cakephp/img/25.jpg" alt="" width="52" height="52" />
        ...
        <div class="one-fourth ">
            <div class="random-numbers">
                <img src="/cakephp/img/31.jpg" alt="" width="52" height="52" />
        ...
        <div class="one-fourth last">
            <div class="random-numbers">
                <img src="/cakephp/img/41.jpg" alt="" width="52" height="52" />
                <p>...Weekly Coffee!</p>
...
<?php
    ...
    echo $this->Html->script('portfolios/filterable/js/jquery.filterable');
    echo $this->Html->script('jquery.tipsy');
    echo $this->Html->script('responsive');
    echo $this->Html->script('jquery.mobilemenu');
    echo $this->Html->script('shortcodes');
    echo $this->Html->script('jquery/jquery.masonry.min');
